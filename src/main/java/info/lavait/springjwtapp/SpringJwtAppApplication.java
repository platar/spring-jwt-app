...
public class SpringJwtAppApplication {
	...
	CommandLineRunner run(UserService userService){
		return args -> {
			...
			userService.saveUser(new User(null, "Arnold Schwarz", "arnold", "1234", new ArrayList<>()));
